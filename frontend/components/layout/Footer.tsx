    ...
    <footer className="bg-[#0D1B2A] border-t-4 border-[#E8892C]">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <h3 className="text-[#E8892C] text-xs font-semibold uppercase tracking-wider mb-4">Quick Links</h3>
            <ul className="flex flex-col gap-2">
              {QUICK_LINKS.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-white/60 hover:text-[#E8892C] text-sm transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="text-[#E8892C] text-xs font-semibold uppercase tracking-wider mb-4">Organisation</h3>
            <ul className="flex flex-col gap-2">
              {ORG_LINKS.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-white/60 hover:text-[#E8892C] text-sm transition-colors">
          ...
          {/* Column 4 — Connect */}
          <div>
            <h3 className="text-[#E8892C] text-xs font-semibold uppercase tracking-wider mb-4">Connect</h3>
